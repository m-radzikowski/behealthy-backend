...
import co.blastlab.behealthy.app.model.EndoRequest;
import co.blastlab.behealthy.app.model.User;
import co.blastlab.behealthy.app.model.Workout;
...
public class SynchronizeBean {
    ...
    @GET
    public User sync(@PathParam("userId") Integer id) throws ParseException {
        User user = getUser(id);
        List<Workout> workouts = getWorkouts(user);
        calculateExp(user, workouts);
    ...
    private void calculateExp(User user, List<Workout> workouts) {
